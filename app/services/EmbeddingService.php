...
class EmbeddingService
{
     ...
     */
    public function processTableData(string $table, array $columns, int $chunkSize = 100): void
    {
        DB::table($table)
    ...
    public function findRelevantContext(array $userEmbedding, int $limit = 1): array
    {
